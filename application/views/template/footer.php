...
<!-- 
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong><span>PRIVAT</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
  ...
  <script src="<?=base_url()?>asset/lumnia/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="<?=base_url()?>asset/lumnia/assets/vendor/jquery.easing/jquery.easing.min.js"></script>
  <script src="<?=base_url()?>asset/lumnia/assets/vendor/php-email-form/validate.js"></script>
  <script src="<?=base_url()?>asset/lumnia/assets/vendor/waypoints/jquery.waypoints.min.js"></script>
  <script src="<?=base_url()?>asset/lumnia/assets/vendor/counterup/counterup.min.js"></script>
  <script src="<?=base_url()?>asset/lumnia/assets/vendor/isotope-layout/isotope.pkgd.min.js"></script>
  <script src="<?=base_url()?>asset/lumnia/assets/vendor/venobox/venobox.min.js"></script>
  <script src="<?=base_url()?>asset/lumnia/assets/vendor/owl.carousel/owl.carousel.min.js"></script>

  <!-- Template Main JS File -->
  <script src="<?=base_url()?>asset/lumnia/assets/js/main.js"></script>
